...
ActiveRecord::Schema.define(version: 20160523144215) do
  ...
  add_index "users_organizations", ["organizations_id"], name: "index_users_organizations_on_organizations_id", using: :btree
